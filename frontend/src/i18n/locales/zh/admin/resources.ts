export default {
    ...
    proxies: {
      ...
      nativeInput: '分享链接或 Sing-box 配置',
      nativeInputPlaceholder: '粘贴 vless://、vmess://、trojan://、ss://，或 Sing-box outbound / endpoint / 完整配置',
      nativePreview: '解析并选择节点',
      nativePreviewing: '解析中...',
      nativePreviewFailed: '无法解析原生代理输入',
      nativeNameOptional: '可选；留空使用节点名称',
      nativePublic: '公开给所有用户使用',
      nativeCreated: '原生代理已启动',
      nativeCreatedWithError: '代理已创建，但启动失败；请检查运行状态',
      nativeSelectAll: '全选节点',
      nativeBatchCreated: '已创建并启动 {count} 个原生代理',
      nativeBatchCreatedWithIssues: '已创建 {count} 个原生代理：{healthy} 个正常，{issues} 个需检查运行状态',
