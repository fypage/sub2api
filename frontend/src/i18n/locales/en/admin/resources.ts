export default {
    ...
    proxies: {
      ...
      nativeAdd: 'Xray / Sing-box',
      nativeInput: 'Share link or Sing-box configuration',
      nativeInputPlaceholder: 'Paste vless://, vmess://, trojan://, ss://, or a Sing-box outbound, endpoint, or full configuration',
      nativePreview: 'Parse and select node',
      nativePreviewing: 'Parsing...',
      nativePreviewFailed: 'Unable to parse native proxy input',
      nativeNameOptional: 'Optional; leave blank to use the node name',
      ...
      nativeSelectAll: 'Select all nodes',
      nativeBatchCreated: 'Created and started {count} native proxies',
      nativeBatchCreatedWithIssues: 'Created {count} native proxies: {healthy} healthy, {issues} require runtime inspection',
